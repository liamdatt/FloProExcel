...
export async function showRulesDialog(opts?: {
  ...
  const refreshTabUi = (): void => {
    ...
    if (activeTab === "user") {
      ...
      hint.textContent =
        "Guidance given to FloPro in all your conversations. FloPro can also update these when you tell it your preferences — e.g. \"always use EUR\".";
    ...
    if (activeTab === "workbook") {
      ...
      hint.textContent = !workbookId
        ...
        : "Guidance given to FloPro only when it reads this file.";
