...
const CORE_TOOL_CAPABILITY_METADATA = {
  ...
  workbook_history: {
    tier: "core",
    category: "recovery",
    promptDescription: "list/restore/delete automatic backups created before FloPro edits for supported workbook mutations (`write_cells`, `fill_formula`, `python_transform_range`, `format_cells`, `conditional_format`, `comments`, and supported `modify_structure` actions)",
  },
  skills: {
    tier: "core",
    category: "skills",
...
export const TOOL_UI_METADATA = {
  ...
  jamaica_market: { renderer: true, humanizer: true },
